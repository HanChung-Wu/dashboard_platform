...
````artifact
id: editable-title-component
name: EditableTitle 元件
type: code.tsx
content: |-
...
````artifact
id: action-buttons-component
name: ActionButtons 元件
type: code.tsx
content: |-
...
````artifact
id: use-file-parser-hook
name: useFileParser Hook
type: code.tsx
content: |-
...
````artifact
id: use-table-editor-hook
name: useTableEditor Hook
type: code.tsx
content: |-
...
````artifact
id: refactored-main-component
name: 重構後的 DataTableEditorPage
type: code.tsx
content: |-
// src/pages/DataTableEditorPage.tsx
